...
variable "resource_names" {
  ...
  default = {
    ...
    version_control_system_repository                           = "iac-alz-compositions"
    version_control_system_repository_templates                 = "{{service_name}}-{{environment_name}}-templates"
    version_control_system_environment_plan                     = "prod-ci-plan"
    version_control_system_environment_apply                    = "prod-cd-apply"
